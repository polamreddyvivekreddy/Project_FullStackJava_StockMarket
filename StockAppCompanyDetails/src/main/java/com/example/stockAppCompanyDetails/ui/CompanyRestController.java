...
//			throws CompanyNotFoundException {
//		CompanyEntity companyEntity = companyService.findByCompanyId(companyId);
//		ModelMapper mapper = new ModelMapper();
//		mapper.getConfiguration().setMatchingStrategy(MatchingStrategies.STRICT);
...
//	}
  ...
  public CompanyDto getCompanyDto(@PathVariable Integer companyId) throws Exception {
      return companyService.getCompanyDto(companyId);
  }
}
